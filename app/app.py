...
# wordpress
api.add_resource(Wordpress, '/wordpress/<string:name>')
api.add_resource(WordpressList, '/wordpress')
# database
api.add_resource(Db, '/db/<string:name>')
api.add_resource(DbList, '/db')
# cPanel
api.add_resource(Cpanel, '/cpanel/<string:name>')
api.add_resource(CpanelList, '/cpanel')
# ftp
api.add_resource(Ftp, '/ftp/<string:name>')
...
@app.route('/')
def hello():
    return render_template('accessFinder/index.html')
